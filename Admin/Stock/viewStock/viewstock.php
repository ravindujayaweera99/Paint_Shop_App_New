            ...
            <?php
              if (isset($_GET['type'])) {
                  ...
                  if (mysqli_num_rows($result) > 0) {
                    echo "<table>";
                    echo "<tr><th>Item Code</th><th>Supplier</th></th><th>Item Name</th><th>Item Type</th><th>Volume (L)</th><th>Quantity</th><th>Minimum Quantity</th><th>Unit Price</th><th>Discount</th><th>Net Value</th><th>Total Cost</th></tr>";
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                      ...
                      echo "<td>" . $row["quantity"] * $row["net_value"] . "</td>";
                      echo "</tr>";
                    }
